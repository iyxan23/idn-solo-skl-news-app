...
import com.iyxan.newz.DetailActivity
import com.iyxan.newz.R
import com.iyxan.newz.data.ArticlesItem
import com.iyxan.newz.databinding.ItemNewsOneBinding
...
class NewsAdapter : RecyclerView.Adapter<NewsAdapter.MyViewHolder>() {
    ...
    // yeah i agree but for the sake of simplicity
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.apply {
            Log.i("NewsAdapter", "binding brow, $news")
