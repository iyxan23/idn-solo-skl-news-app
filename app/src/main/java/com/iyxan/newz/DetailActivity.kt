...
import com.iyxan.newz.data.ArticlesItem
import com.iyxan.newz.databinding.ActivityDetailBinding
...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.apply {
            ...
            if (newsData?.source?.name != null) {
                title = newsData.source.name
                subtitle = newsData.title ?: getString(R.string.news_detail)
            } else {
                title = newsData?.title ?: getString(R.string.news_detail)
            }
        }
